...
DEDUCTIONS: dict[str, int] = {
    ...
    "DUPLICATE_FILE_UPLOAD": 20,
    "DUPLICATE_ROW_IN_BATCH": 15,
    "CROSS_BATCH_DUPLICATE": 20,
    "DOUBLE_COUNT_RISK": 20,
    "REQUIRES_RECONCILIATION": 15,
    ...
    "DUPLICATE_TRAVEL_EVENT": 15,
    "ROUND_TRIP_DUPLICATE_RISK": 10,
    "DUPLICATE_TRAVEL_SYNC": 20,
