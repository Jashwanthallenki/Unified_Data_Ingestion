...
const FLAG_COLORS: Record<string, string> = {
  ...
  DUPLICATE_FILE_UPLOAD: "border-rose-200 bg-rose-50 text-rose-700",
  DUPLICATE_ROW_IN_BATCH: "border-rose-200 bg-rose-50 text-rose-700",
  CROSS_BATCH_DUPLICATE: "border-rose-200 bg-rose-50 text-rose-700",
  DUPLICATE_SAP_ROW: "border-rose-200 bg-rose-50 text-rose-700",
  DUPLICATE_BILL_ACCOUNT_PERIOD: "border-rose-200 bg-rose-50 text-rose-700",
  OVERLAPPING_BILLING_PERIOD: "border-amber-200 bg-amber-50 text-amber-800",
  DUPLICATE_TRAVEL_EVENT: "border-rose-200 bg-rose-50 text-rose-700",
  DUPLICATE_TRAVEL_SYNC: "border-rose-200 bg-rose-50 text-rose-700",
  DUPLICATE_FUEL_SOURCE: "border-rose-200 bg-rose-50 text-rose-700",
  DOUBLE_COUNT_RISK: "border-rose-200 bg-rose-50 text-rose-700",
  REQUIRES_RECONCILIATION: "border-amber-200 bg-amber-50 text-amber-800",
